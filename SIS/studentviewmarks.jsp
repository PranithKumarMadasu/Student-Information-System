              ...
              <div class="row">
                <div class="col-md-8 mx-auto">
                  <div class="detail_box">
                    ...
                    <p>
			<form action="viewmarks1.jsp" method="post">
        <table align="Center" width=65%  style="font-size:20px;">
	  
	  <tr><th style="color:yellow;">Student ID</th><th><input type="Text" name="studentid" value="<%= session.getAttribute("StudentID") %>" required /></th></tr>
