...
<body>
  ...
  <div class="hero_area">
    ...
    <section class="slider_section ">
	  ...
	  <tr><th>Student Id</th><th>Semester</th><th>Subject</th>
	  <th>Mid I</th><Th>Mid II</th><th>University Exam</th>
	  <th>Total</th></tr>
	  <%
	  
	  String sem=request.getParameter("sem");
	  PreparedStatement pst=con.prepareStatement("Select * from studentmarks where sem=?");
