...
<body>
  ...
  <div class="hero_area">
    ...
    <table align="Center" width=90%  style="font-size:20px;color:white;" border=5>
<tr><th>Name</th><th>Email Id</th><th>Mobile Number</th><th>Address</th><th>Department</th><th>operation</th></tr>
<%@include file="DBConn.jsp" %>
<%
  PreparedStatement pst=con.prepareStatement("select * from faculty where status=0");
...
<th>
<a href="acceptfaculty.jsp?stdid=<%= rs.getString(1)%>"> Accept</a>/
<a href="rejectfaculty.jsp?stdid=<%= rs.getString(1)%>"> Reject</a>
