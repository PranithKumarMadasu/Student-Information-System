...
<body>
  ...
  <div class="hero_area">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="approvestudent.jsp">Approve Students</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="approvefaculty.jsp">Approve Faculty </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="adminviewstudentdetails.jsp">View Student Details
				  </a>
                </li>
               <li class="nav-item">
    ...
    <table align="Center" width=90%  style="font-size:23px;color:black;" border=5>
<tr><th>StudentID</th><th>Email Id</th><th>Mobile Number</th><th>Address</th><th>Department</th><th>operation</th></tr>
