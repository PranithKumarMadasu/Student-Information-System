...
<body>
  ...
  <div class="hero_area">
    ...
    <section class="slider_section ">
	  ...
	  <table align="Center"  style="font-size:20px;table-layout: fixed; width: 100%;border:1px solid black;">
	  
	  <%
	  String stdid=request.getParameter("studentid");
	  String sem=request.getParameter("sem");
	  PreparedStatement pst=con.prepareStatement("Select * from attendance where studentid=? and sem=?");
	  ...
	  <tr>
	  <td style="background-color: #96D4D4;color: black;">Student ID</td>
	  <td style="background-color: #f2f2f2;color: black;"> 
	  <%= studentID %>
	  </td>
	  </tr>
	  <tr>
	  <td style="background-color: #96D4D4;color: black;">Year/Sem</td>
	  <td style="background-color: #f2f2f2;color: black;"> 
	  <%= year %>
	  </td>
	  </tr>
	 ...
	 <br><Br><br>
	  ...
	  <th style="background-color: #96D4D4;color: black;">Subject</th>
	  
	  <th style="background-color: #96D4D4;color: black;">Attendance(%)</th></tr>
	  <%
	  String stdid1=request.getParameter("studentid");
	  String sem1=request.getParameter("sem");
	  PreparedStatement pst1=con.prepareStatement("Select * from attendance where studentid=? and sem=?");
	  ...
	  while(rs1.next())
	  { 
		  switch(rs1.getString(2)){
			case "Sem-1": year1="I / I"; break;
			case "Sem-2": year1="I / II"; break;
			case "Sem-3": year1="II / I"; break;
			case "Sem-4": year1="II / II"; break;
			case "Sem-5": year1="III / I"; break;
			case "Sem-6": year1="III / II"; break;
			case "Sem-7": year1="IV / I"; break;
			case "Sem-8": year1="IV / II"; break;
		  }
		  %>
	    <tr>
		   <th style="background-color: #f2f2f2;color: black;"><%= rs1.getString(3) %></th>
			 <th style="background-color: #f2f2f2;color: black;"><%= rs1.getString(4) %></th>
