...
<body>
              ...
              <div class="row">
                <div class="col-md-8 mx-auto">
                  <div class="detail_box">
                    ...
                    <p>
			<form action="addmarks1.jsp" method="post">
        <table align="Center" width=65%  style="font-size:20px;">
 ...
 <tr><th style="color:yellow;"> Mid I </th><th><input type="number" name="mid1" placeholder="Enter Mid I Marks" required min=0 max=25/></th></tr>

 <tr><th style="color:yellow;"> Mid II </th><th><input type="number" name="mid2" placeholder="Enter Mid II Marks" required min=0 max=25/></th></tr>
  
 <tr><th style="color:yellow;">University Exam</th><th><input type="number" name="semexam" placeholder="Enter Semester Marks" required min=0 max=75/></th></tr>


      <tr><th><input type="submit" value="Add Marks" /></th>
