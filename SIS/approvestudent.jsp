...
<body>
  ...
  <div class="hero_area">
              ...
              <ul class="navbar-nav  ">
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<li class="nav-item">
							<a class="nav-link" href="approvestudent.jsp">Students</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="approvefaculty.jsp">Faculty</a>
						</li>
					</div>
				</div>
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<li class="nav-item">
							<a class="nav-link" href="adminviewmarks.jsp">Marks</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="adminviewattendance.jsp">Attendance</a>
						</li>
					</div>
				</div>
               <li class="nav-item">
    ...
    <table align="Center" width=90%  style="font-size:22px;color:white;" border=5>
<tr><th>Student ID</th><th>Email Id</th><th>Mobile Number</th><th>Address</th><th>Department</th><th>Operation</th></tr>
<%@include file="DBConn.jsp" %>
<%
  PreparedStatement pst=con.prepareStatement("select * from student where status=0");
...
<th>
<a href="acceptstudent.jsp?stdid=<%= rs.getString(1)%>"> Accept</a>/
<a href="rejectstudent.jsp?stdid=<%= rs.getString(1)%>"> Reject</a>
  ...
  <%}
%>
<tr><th colspan=7 align="center" style="color:white;"><a href="adminhome.jsp">Back</a></th></tr>
	  </table>
